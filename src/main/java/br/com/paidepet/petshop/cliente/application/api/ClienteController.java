...
public class ClienteController implements ClienteAPI {
   ...
   /* private ClienteController(ClienteService clienteService) {  //CONSTRUTOR que inicia o ClienteService
    ...
    public ClienteResponse postCliente(ClienteRequest clienteRequest) {
        ...
        ClienteResponse postCliente = clienteService.postCliente(clienteRequest);
    ...
    public ClienteResponseById getClienteById(UUID idCliente) {
        ...
        ClienteResponseById clienteResponseById = clienteService.getClienteById(idCliente);
    ...
    public void patchCliente(UUID idCliente, @Valid ClientePatchRequest clientePatchRequest) {
        ...
        log.info("[idCliente] {}", idCliente);
        clienteService.patchCliente(idCliente, clientePatchRequest);
